...
- iPhone ou iPad: abrir no Safari, usar **Compartilhar** e escolher **Adicionar
  à Tela de Início**;
...
No iPhone e no iPad, o usuário deve abrir o ícone instalado antes de ativar as
notificações. Em qualquer plataforma, a permissão só é solicitada depois do
